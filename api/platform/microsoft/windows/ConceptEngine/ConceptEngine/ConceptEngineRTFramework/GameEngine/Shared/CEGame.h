...
#include "../../Libs/ReadDirectoryChanges/ReadDirectoryChanges.h"
...
namespace Concept::GameEngine {
	 ...
	 */
	using CEWindowProcEvent = Actions::Delegate<LRESULT(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)>;
	...
	public:
		 ...
		 */
		std::shared_ptr<CEWindow> GetWindowByName(const std::wstring& windowName) const;
		 ...
		 */
		Actions::FileChangeEvent FileChanged;
	...
	protected:
		 ...
		 */
		virtual void OnFileChange(Actions::FileChangedEventArgs& e);
		 ...
		 */
		virtual void OnExit(Actions::EventArgs& e);
	private:
		/*
		 * Private and deleted.
		 */
