...
bool CEDirect3DGraphics::InitCubes() {
	...
	systemInfo_ = GetSystemInfo(adapter);
	...
	swapChainDesc.Flags = g_VSync ? DXGI_SWAP_CHAIN_FLAG_ALLOW_TEARING : 0;
	...
	hr = m_device->CreateCommittedResource(
		...
		&CD3DX12_RESOURCE_DESC::Tex2D(DXGI_FORMAT_D32_FLOAT, g_ClientWidth, g_ClientHeight, 1, 1, 1, 0,
...
void CEDirect3DGraphics::RenderCubes() {
	...
	UINT syncInterval = g_VSync ? 0 : 1;
	UINT presentFlags = g_VSync ? DXGI_PRESENT_ALLOW_TEARING : 0;
