...
public:
	CEImGUI(CEGUIType guiType, CEGraphicsApiType apiType);
	CEImGUI(const CEImGUI&) = delete;
	virtual CEImGUI& operator=(const CEImGUI&) = delete;
	virtual ~CEImGUI() = default;

public:
	static CEImGUI* Create(CEGUIType guiType, CEGraphicsApiType apiType);
