...
CEImGUI::CEImGUI(CEGUIType guiType, CEGraphicsApiType apiType): context(nullptr), guiType_(guiType), apiType_(apiType) {

}

CEImGUI* CEImGUI::Create(CEGUIType guiType, CEGraphicsApiType apiType) {
	return new CEImGUI(guiType, apiType);
}

void CEImGUI::InitDirect3D12ImGUI(HWND hWnd,
                                ID3D12Device* device,
...
void CEImGUI::CreateSystemInfoWindow(CEOSTools::CESystemInfo systemInfo) {
	if (systemInfoWindow) {
...
void CEImGUI::CreateSceneEditorWindow() {
...
ImVec4 CEImGUI::GetBgColor() const {
	return bgColor;
}

void CEImGUI::CreateTopMenu() {
