...
namespace ConceptFramework::GraphicsEngine::Direct3D {
    ...
    struct CEVertexPosition
    {
        ...
        explicit CEVertexPosition(const DirectX::XMFLOAT3& position)
            : Position(position)
        {}
    ...
    struct CEVertexPositionNormalTangentBitangentTexture
    {
        ...
        explicit CEVertexPositionNormalTangentBitangentTexture(const DirectX::XMFLOAT3& position,
        ...
        explicit CEVertexPositionNormalTangentBitangentTexture(DirectX::FXMVECTOR position, DirectX::FXMVECTOR normal,
