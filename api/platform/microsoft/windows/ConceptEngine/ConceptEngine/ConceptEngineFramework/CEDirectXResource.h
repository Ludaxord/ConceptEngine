...
namespace ConceptEngine::GraphicsEngine::Direct3D12 {
	...
	protected:
		 ...
		 */
		CEDirectXResource(CEDirectXDevice& device, const D3D12_RESOURCE_DESC& resourceDesc,
		                  const D3D12_CLEAR_VALUE* clearValue = nullptr);
		CEDirectXResource(CEDirectXDevice& device, wrl::ComPtr<ID3D12Resource> resource,
		                  const D3D12_CLEAR_VALUE* clearValue = nullptr);
		virtual ~CEDirectXResource() = default;
