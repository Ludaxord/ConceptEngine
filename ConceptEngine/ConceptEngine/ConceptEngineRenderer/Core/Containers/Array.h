...
public:
	...
	explicit CEArray(SizeType Size) noexcept
		: Array(nullptr)
		  , ArraySize(0)
		  , ArrayCapacity(0)
		  , Allocator() {
	...
	explicit CEArray(SizeType Size, const T& Value) noexcept
		: Array(nullptr)
		  , ArraySize(0)
		  , ArrayCapacity(0)
		  , Allocator() {
	...
	explicit CEArray(TInput Begin, TInput End) noexcept
		: Array(nullptr)
		  , ArraySize(0)
		  , ArrayCapacity(0)
		  , Allocator() {
	...
	CEArray(std::initializer_list<T> List) noexcept
		: Array(nullptr)
		  , ArraySize(0)
		  , ArrayCapacity(0)
		  , Allocator() {
