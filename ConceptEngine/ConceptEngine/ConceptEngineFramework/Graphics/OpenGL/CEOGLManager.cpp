...
void ConceptEngineFramework::Graphics::OpenGL::CEOGLManager::CreatePhysics() {
}
...
void ConceptEngineFramework::Graphics::OpenGL::CEOGLManager::Resize() {
}

bool ConceptEngineFramework::Graphics::OpenGL::CEOGLManager::Initialized() {
	return false;
}
