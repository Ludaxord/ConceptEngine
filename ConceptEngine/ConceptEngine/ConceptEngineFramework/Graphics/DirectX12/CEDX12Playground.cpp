...
void CEDX12Playground::BuildShadersAndInputLayout() {
	m_shadersMap["standardVS"] = m_dx12manager->CompileShaders("CEBasicVertexShader.hlsl",
	                                                           nullptr,
	                                                           "VS",
	                                                           // "vs_6_3"
	                                                           "vs_5_1"
	);
	m_shadersMap["opaquePS"] = m_dx12manager->CompileShaders("CEBasicPixelShader.hlsl",
	                                                         nullptr,
	                                                         "PS",
	                                                         // "ps_6_3"
	                                                         "ps_5_1"
