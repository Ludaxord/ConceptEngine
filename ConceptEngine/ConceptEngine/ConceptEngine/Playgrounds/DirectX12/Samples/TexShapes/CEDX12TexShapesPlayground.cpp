#include "CEDX12TexShapesPlayground.h"
...
CEDX12TexShapesPlayground::CEDX12TexShapesPlayground(): CEDX12Playground() {
}

void CEDX12TexShapesPlayground::Create() {
	...
	//RootSignature
	{
		...
		CD3DX12_ROOT_SIGNATURE_DESC rootSignatureDesc(4, slotRootParameter, (UINT)staticSamplers.size(),
		                                              staticSamplers.data(),
...
void CEDX12TexShapesPlayground::Update(const CETimer& gt) {
...
void CEDX12TexShapesPlayground::Render(const CETimer& gt) {
	...
	ThrowIfFailed(m_dx12manager->GetD3D12CommandList()->Reset(cmdListAlloc.Get(), mPSOs[(mIsWireframe ? "opaque_wireframe" : "opaque")].Get()));
...
void CEDX12TexShapesPlayground::Resize() {
...
void CEDX12TexShapesPlayground::OnMouseDown(KeyCode key, int x, int y) {
...
void CEDX12TexShapesPlayground::OnMouseUp(KeyCode key, int x, int y) {
	CEDX12Playground::OnMouseUp(key, x, y);

	ReleaseCapture();
}

void CEDX12TexShapesPlayground::OnMouseMove(KeyCode key, int x, int y) {
...
void CEDX12TexShapesPlayground::OnKeyUp(KeyCode key, char keyChar, const CETimer& gt) {
	CEDX12Playground::OnKeyUp(key, keyChar, gt);
}

void CEDX12TexShapesPlayground::OnKeyDown(KeyCode key, char keyChar, const CETimer& gt) {
	CEDX12Playground::OnKeyDown(key, keyChar, gt);
}

void CEDX12TexShapesPlayground::OnMouseWheel(KeyCode key, float wheelDelta, int x, int y) {
	CEDX12Playground::OnMouseWheel(key, wheelDelta, x, y);
}

void CEDX12TexShapesPlayground::UpdateCamera(const CETimer& gt) {
...
void CEDX12TexShapesPlayground::AnimateMaterials(const CETimer& gt) {
	CEDX12Playground::AnimateMaterials(gt);
}

void CEDX12TexShapesPlayground::UpdateObjectCBs(const CETimer& gt) {
...
void CEDX12TexShapesPlayground::UpdateMaterialCBs(const CETimer& gt) {
...
void CEDX12TexShapesPlayground::UpdateMainPassCB(const CETimer& gt) {
...
void CEDX12TexShapesPlayground::LoadTextures() {
...
void CEDX12TexShapesPlayground::BuildDescriptorHeaps() {
	...
	d3dDevice->CreateShaderResourceView(bricksTex.Get(), &srvDesc, handleDesc);

	//next descriptor
	handleDesc.Offset(1, size);

	srvDesc.Format = stoneTex->GetDesc().Format;
	srvDesc.Texture2D.MipLevels = stoneTex->GetDesc().MipLevels;
	d3dDevice->CreateShaderResourceView(stoneTex.Get(), &srvDesc, handleDesc);
	...
	d3dDevice->CreateShaderResourceView(tileTex.Get(), &srvDesc, handleDesc);
}

void CEDX12TexShapesPlayground::BuildShapeGeometry() {
...
void CEDX12TexShapesPlayground::BuildMaterials() {
...
void CEDX12TexShapesPlayground::BuildRenderItems() {
...
void CEDX12TexShapesPlayground::BuildFrameResources() {
...
void CEDX12TexShapesPlayground::DrawRenderItems(ID3D12GraphicsCommandList* cmdList,
