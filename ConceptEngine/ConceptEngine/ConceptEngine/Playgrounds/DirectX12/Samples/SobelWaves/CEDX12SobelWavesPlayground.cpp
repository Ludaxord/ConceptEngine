#include "CEDX12SobelWavesPlayground.h"
...
CEDX12SobelWavesPlayground::CEDX12SobelWavesPlayground() : CEDX12Playground() {
}

void CEDX12SobelWavesPlayground::Create() {
...
void CEDX12SobelWavesPlayground::Update(const CETimer& gt) {
...
void CEDX12SobelWavesPlayground::Resize() {
...
void CEDX12SobelWavesPlayground::OnMouseUp(KeyCode key, int x, int y) {
	CEDX12Playground::OnMouseUp(key, x, y);

	ReleaseCapture();
}

void CEDX12SobelWavesPlayground::OnMouseMove(KeyCode key, int x, int y) {
...
void CEDX12SobelWavesPlayground::OnKeyUp(KeyCode key, char keyChar, const CETimer& gt) {
	CEDX12Playground::OnKeyUp(key, keyChar, gt);
}

void CEDX12SobelWavesPlayground::OnKeyDown(KeyCode key, char keyChar, const CETimer& gt) {
...
void CEDX12SobelWavesPlayground::OnMouseWheel(KeyCode key, float wheelDelta, int x, int y) {
	CEDX12Playground::OnMouseWheel(key, wheelDelta, x, y);
}

void CEDX12SobelWavesPlayground::UpdateCamera(const CETimer& gt) {
...
void CEDX12SobelWavesPlayground::AnimateMaterials(const CETimer& gt) {
...
void CEDX12SobelWavesPlayground::UpdateObjectCBs(const CETimer& gt) {
...
void CEDX12SobelWavesPlayground::UpdateMaterialCBs(const CETimer& gt) {
...
void CEDX12SobelWavesPlayground::UpdateMainPassCB(const CETimer& gt) {
...
void CEDX12SobelWavesPlayground::LoadTextures() {
...
void CEDX12SobelWavesPlayground::BuildTreeSpritesGeometry() {
...
void CEDX12SobelWavesPlayground::BuildBoxGeometry() {
...
void CEDX12SobelWavesPlayground::BuildMaterials() {
...
void CEDX12SobelWavesPlayground::BuildRenderItems() {
...
void CEDX12SobelWavesPlayground::BuildFrameResources() {
...
void CEDX12SobelWavesPlayground::DrawRenderItems(ID3D12GraphicsCommandList* cmdList,
...
float CEDX12SobelWavesPlayground::GetHillsHeight(float x, float z) const {
	return 0.3f * (z * sinf(0.1f * x) + x * cosf(0.1f * z));
}

XMFLOAT3 CEDX12SobelWavesPlayground::GetHillsNormal(float x, float z) const {
	// n = (-df/dx, 1, -df/dz)
	XMFLOAT3 n(
