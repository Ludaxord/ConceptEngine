#include "CEDX12TexWavesPlayground.h"
...
CEDX12TexWavesPlayground::CEDX12TexWavesPlayground() : CEDX12Playground() {
}

void CEDX12TexWavesPlayground::Create() {
	...
	BuildNormalShadersAndInputLayout("CELitTexWavesVertexShader.hlsl", "CELitTexWavesPixelShader.hlsl");
	BuildLandGeometry();
...
void CEDX12TexWavesPlayground::Update(const CETimer& gt) {
...
void CEDX12TexWavesPlayground::Render(const CETimer& gt) {
...
void CEDX12TexWavesPlayground::Resize() {
...
void CEDX12TexWavesPlayground::OnMouseDown(KeyCode key, int x, int y) {
...
void CEDX12TexWavesPlayground::OnMouseUp(KeyCode key, int x, int y) {
	CEDX12Playground::OnMouseUp(key, x, y);

	ReleaseCapture();
}

void CEDX12TexWavesPlayground::OnMouseMove(KeyCode key, int x, int y) {
...
void CEDX12TexWavesPlayground::OnKeyUp(KeyCode key, char keyChar, const CETimer& gt) {
...
void CEDX12TexWavesPlayground::UpdateCamera(const CETimer& gt) {
...
void CEDX12TexWavesPlayground::AnimateMaterials(const CETimer& gt) {
...
void CEDX12TexWavesPlayground::UpdateObjectCBs(const CETimer& gt) {
...
void CEDX12TexWavesPlayground::UpdateMaterialCBs(const CETimer& gt) {
...
void CEDX12TexWavesPlayground::UpdateMainPassCB(const CETimer& gt) {
...
void CEDX12TexWavesPlayground::LoadTextures() {
	...
	auto fenceTex = m_dx12manager->LoadTextureFromFile("WoodCrate01.dds", "fenceTex");
...
void CEDX12TexWavesPlayground::BuildDescriptorHeaps() {
...
void CEDX12TexWavesPlayground::BuildLandGeometry() {
...
void CEDX12TexWavesPlayground::BuildWavesGeometryBuffers() {
...
void CEDX12TexWavesPlayground::BuildBoxGeometry() {
...
void CEDX12TexWavesPlayground::BuildMaterials() {
...
void CEDX12TexWavesPlayground::BuildRenderItems() {
...
void CEDX12TexWavesPlayground::BuildFrameResources() {
...
void CEDX12TexWavesPlayground::DrawRenderItems(ID3D12GraphicsCommandList* cmdList,
...
float CEDX12TexWavesPlayground::GetHillsHeight(float x, float z) const {
	return 0.3f * (z * sinf(0.1f * x) + x * cosf(0.1f * z));
}

XMFLOAT3 CEDX12TexWavesPlayground::GetHillsNormal(float x, float z) const {
	// n = (-df/dx, 1, -df/dz)
	XMFLOAT3 n(
...
void CEDX12TexWavesPlayground::UpdateWaves(const CETimer& gt) {
