...
CEDX12SSAOPlayground::CEDX12SSAOPlayground() : CEDX12Playground() {
	/*
...
void CEDX12SSAOPlayground::Update(const CETimer& gt) {
...
void CEDX12SSAOPlayground::OnMouseUp(KeyCode key, int x, int y) {
	CEDX12Playground::OnMouseUp(key, x, y);
	ReleaseCapture();
}

void CEDX12SSAOPlayground::OnMouseMove(KeyCode key, int x, int y) {
...
void CEDX12SSAOPlayground::OnKeyUp(KeyCode key, char keyChar, const CETimer& gt) {
	CEDX12Playground::OnKeyUp(key, keyChar, gt);
}

void CEDX12SSAOPlayground::OnKeyDown(KeyCode key, char keyChar, const CETimer& gt) {
...
void CEDX12SSAOPlayground::UpdateMainPassCB(const CETimer& gt) {
...
void CEDX12SSAOPlayground::UpdateMaterialCBs(const CETimer& gt) {
...
void CEDX12SSAOPlayground::LoadTextures() {
...
void CEDX12SSAOPlayground::BuildShapesGeometry() {
...
void CEDX12SSAOPlayground::BuildMaterials() {
...
void CEDX12SSAOPlayground::BuildRenderItems() {
	//
...
void CEDX12SSAOPlayground::BuildCubeFaceCamera(float x, float y, float z) {
...
void CEDX12SSAOPlayground::BuildCubeDepthStencil() {
...
void CEDX12SSAOPlayground::AnimateSkullMovement(const CETimer& gt) const {
...
void CEDX12SSAOPlayground::UpdateShadowTransform(const CETimer& gt) {
...
void CEDX12SSAOPlayground::DrawSceneToShadowMap() {
