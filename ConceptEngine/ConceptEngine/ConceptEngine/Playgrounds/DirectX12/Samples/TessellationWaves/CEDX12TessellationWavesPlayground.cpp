...
void CEDX12TessellationWavesPlayground::BuildTreeSpritesGeometry() {
...
void CEDX12TessellationWavesPlayground::BuildWavesGeometryBuffers() {
...
void CEDX12TessellationWavesPlayground::BuildBoxGeometry() {
	GeometryGenerator geoGen;
...
void CEDX12TessellationWavesPlayground::DrawFullscreenQuad(ID3D12GraphicsCommandList* cmdList) {
...
void CEDX12TessellationWavesPlayground::UpdateWavesGPU(const CETimer& gt) {
