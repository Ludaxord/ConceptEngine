#include "CEDX12BezierTessellationWavesPlayground.h"
...
CEDX12BezierTessellationWavesPlayground::CEDX12BezierTessellationWavesPlayground() : CEDX12Playground() {
}

void CEDX12BezierTessellationWavesPlayground::Create() {
...
void CEDX12BezierTessellationWavesPlayground::Update(const CETimer& gt) {
...
void CEDX12BezierTessellationWavesPlayground::Render(const CETimer& gt) {
...
void CEDX12BezierTessellationWavesPlayground::Resize() {
...
void CEDX12BezierTessellationWavesPlayground::OnMouseDown(KeyCode key, int x, int y) {
...
void CEDX12BezierTessellationWavesPlayground::OnMouseUp(KeyCode key, int x, int y) {
	CEDX12Playground::OnMouseUp(key, x, y);

	ReleaseCapture();
}

void CEDX12BezierTessellationWavesPlayground::OnMouseMove(KeyCode key, int x, int y) {
...
void CEDX12BezierTessellationWavesPlayground::OnKeyUp(KeyCode key, char keyChar, const CETimer& gt) {
	CEDX12Playground::OnKeyUp(key, keyChar, gt);
}

void CEDX12BezierTessellationWavesPlayground::OnKeyDown(KeyCode key, char keyChar, const CETimer& gt) {
...
void CEDX12BezierTessellationWavesPlayground::OnMouseWheel(KeyCode key, float wheelDelta, int x, int y) {
	CEDX12Playground::OnMouseWheel(key, wheelDelta, x, y);
}

void CEDX12BezierTessellationWavesPlayground::UpdateCamera(const CETimer& gt) {
...
void CEDX12BezierTessellationWavesPlayground::AnimateMaterials(const CETimer& gt) {
	CEDX12Playground::AnimateMaterials(gt);

}

void CEDX12BezierTessellationWavesPlayground::UpdateObjectCBs(const CETimer& gt) {
...
void CEDX12BezierTessellationWavesPlayground::UpdateMaterialCBs(const CETimer& gt) {
...
void CEDX12BezierTessellationWavesPlayground::UpdateMainPassCB(const CETimer& gt) {
...
void CEDX12BezierTessellationWavesPlayground::LoadTextures() {
...
void CEDX12BezierTessellationWavesPlayground::BuildDescriptorHeaps() {
	auto d3dDevice = m_dx12manager->GetD3D12Device();
...
void CEDX12BezierTessellationWavesPlayground::BuildLandGeometry() {
...
void CEDX12BezierTessellationWavesPlayground::BuildMaterials() {
...
void CEDX12BezierTessellationWavesPlayground::BuildRenderItems() {
...
void CEDX12BezierTessellationWavesPlayground::BuildFrameResources() {
...
void CEDX12BezierTessellationWavesPlayground::DrawRenderItems(ID3D12GraphicsCommandList* cmdList,
...
float CEDX12BezierTessellationWavesPlayground::GetHillsHeight(float x, float z) const {
	return 0.3f * (z * sinf(0.1f * x) + x * cosf(0.1f * z));
}

XMFLOAT3 CEDX12BezierTessellationWavesPlayground::GetHillsNormal(float x, float z) const {
	// n = (-df/dx, 1, -df/dz)
	XMFLOAT3 n(
