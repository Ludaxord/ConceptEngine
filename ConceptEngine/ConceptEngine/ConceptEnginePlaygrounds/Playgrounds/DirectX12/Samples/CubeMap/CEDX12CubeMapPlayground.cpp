#include "CEDX12CubeMapPlayground.h"
...
CEDX12CubeMapPlayground::CEDX12CubeMapPlayground() : CEDX12Playground() {
}

void CEDX12CubeMapPlayground::Create() {
...
void CEDX12CubeMapPlayground::Update(const CETimer& gt) {
...
void CEDX12CubeMapPlayground::Render(const CETimer& gt) {
...
void CEDX12CubeMapPlayground::OnMouseUp(KeyCode key, int x, int y) {
	CEDX12Playground::OnMouseUp(key, x, y);
	ReleaseCapture();
}

void CEDX12CubeMapPlayground::OnMouseMove(KeyCode key, int x, int y) {
...
void CEDX12CubeMapPlayground::OnKeyUp(KeyCode key, char keyChar, const CETimer& gt) {
	CEDX12Playground::OnKeyUp(key, keyChar, gt);
}

void CEDX12CubeMapPlayground::OnKeyDown(KeyCode key, char keyChar, const CETimer& gt) {
...
void CEDX12CubeMapPlayground::OnMouseWheel(KeyCode key, float wheelDelta, int x, int y) {
	CEDX12Playground::OnMouseWheel(key, wheelDelta, x, y);
}

void CEDX12CubeMapPlayground::UpdateObjectCBs(const CETimer& gt) {
...
void CEDX12CubeMapPlayground::UpdateMainPassCB(const CETimer& gt) {
...
void CEDX12CubeMapPlayground::UpdateMaterialCBs(const CETimer& gt) {
...
void CEDX12CubeMapPlayground::BuildPSOs(Microsoft::WRL::ComPtr<ID3D12RootSignature> rootSignature) {
...
void CEDX12CubeMapPlayground::LoadTextures() {
...
void CEDX12CubeMapPlayground::BuildDescriptorHeaps() {
...
void CEDX12CubeMapPlayground::BuildModelGeometry() {
...
void CEDX12CubeMapPlayground::BuildShapesGeometry() {
...
void CEDX12CubeMapPlayground::BuildFrameResources() {
...
void CEDX12CubeMapPlayground::BuildMaterials() {
...
void CEDX12CubeMapPlayground::BuildRenderItems() {
...
void CEDX12CubeMapPlayground::DrawRenderItems(ID3D12GraphicsCommandList* cmdList,
