#include "CEDX12TreesWavesPlayground.h"
...
CEDX12TreesWavesPlayground::CEDX12TreesWavesPlayground() : CEDX12Playground() {
}

void CEDX12TreesWavesPlayground::Create() {
...
void CEDX12TreesWavesPlayground::Update(const CETimer& gt) {
...
void CEDX12TreesWavesPlayground::Render(const CETimer& gt) {
...
void CEDX12TreesWavesPlayground::Resize() {
...
void CEDX12TreesWavesPlayground::OnMouseDown(KeyCode key, int x, int y) {
...
void CEDX12TreesWavesPlayground::OnMouseUp(KeyCode key, int x, int y) {
	CEDX12Playground::OnMouseUp(key, x, y);

	ReleaseCapture();
}

void CEDX12TreesWavesPlayground::OnMouseMove(KeyCode key, int x, int y) {
...
void CEDX12TreesWavesPlayground::OnKeyUp(KeyCode key, char keyChar, const CETimer& gt) {
	CEDX12Playground::OnKeyUp(key, keyChar, gt);
}

void CEDX12TreesWavesPlayground::OnKeyDown(KeyCode key, char keyChar, const CETimer& gt) {
...
void CEDX12TreesWavesPlayground::OnMouseWheel(KeyCode key, float wheelDelta, int x, int y) {
	CEDX12Playground::OnMouseWheel(key, wheelDelta, x, y);
}

void CEDX12TreesWavesPlayground::UpdateCamera(const CETimer& gt) {
...
void CEDX12TreesWavesPlayground::AnimateMaterials(const CETimer& gt) {
...
void CEDX12TreesWavesPlayground::UpdateObjectCBs(const CETimer& gt) {
...
void CEDX12TreesWavesPlayground::UpdateMaterialCBs(const CETimer& gt) {
...
void CEDX12TreesWavesPlayground::UpdateMainPassCB(const CETimer& gt) {
...
void CEDX12TreesWavesPlayground::LoadTextures() {
...
void CEDX12TreesWavesPlayground::BuildDescriptorHeaps() {
...
void CEDX12TreesWavesPlayground::BuildLandGeometry() {
...
void CEDX12TreesWavesPlayground::BuildTreeSpritesGeometry() {
...
void CEDX12TreesWavesPlayground::BuildWavesGeometryBuffers() {
...
void CEDX12TreesWavesPlayground::BuildBoxGeometry() {
...
void CEDX12TreesWavesPlayground::BuildMaterials() {
...
void CEDX12TreesWavesPlayground::BuildRenderItems() {
...
void CEDX12TreesWavesPlayground::BuildFrameResources() {
...
void CEDX12TreesWavesPlayground::DrawRenderItems(ID3D12GraphicsCommandList* cmdList,
...
float CEDX12TreesWavesPlayground::GetHillsHeight(float x, float z) const {
	return 0.3f * (z * sinf(0.1f * x) + x * cosf(0.1f * z));
}

XMFLOAT3 CEDX12TreesWavesPlayground::GetHillsNormal(float x, float z) const {
	// n = (-df/dx, 1, -df/dz)
	XMFLOAT3 n(
...
void CEDX12TreesWavesPlayground::UpdateWaves(const CETimer& gt) {
